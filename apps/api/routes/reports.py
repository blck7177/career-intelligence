...
Auth:
  ...
  FitReports are workspace-private and checked against get_current_workspace().
  JobReports are global (user-independent) but still require auth.
"""
...
def get_fit_report(
    ...
    Returns 403 if the report does not belong to the current workspace.
    """
